...
<html lang="en">
    <head>
        ...
        <title>Borders - SB Admin Pro</title>
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        <h1 class="page-header-title">
                                            <div class="page-header-icon"><i data-feather="maximize"></i></div>
                                            Borders
                                        </h1>
                                        <div class="page-header-subtitle">Border utilities allow you to modify the borders of your display elements</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9">
                                ...
                                <div id="default">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <h6 class="small text-muted fw-500">Additive:</h6>
                                                ...
                                                <div class="p-4 border-bottom">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <div class="bg-light border-end p-3">.border-end</div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="bg-light border-bottom p-3 mb-3">.border-bottom</div>
                                                            <div class="bg-light border-start p-3">.border-start</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="bg-light p-4 small">
                                                    The above border utilities will
                                                    <em>add</em>
                                                    borders to any element.
                                                </div>
                                            </div>
                                            <h6 class="small text-muted fw-500">Subtractive:</h6>
                                                ...
                                                <div class="p-4 border-bottom">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <div class="bg-light border border-end-0 p-3">.border-end-0</div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="bg-light border border-bottom-0 p-3 mb-3">.border-bottom-0</div>
                                                            <div class="bg-light border border-start-0 p-3">.border-start-0</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="bg-light p-4 small">
                                                    The above border utilities will
                                                    <em>subtract</em>
                                                    borders from any element that already has them.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="colors">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <h6 class="small text-muted fw-500">Bootstrap Default State Colors:</h6>
                                            <div class="border border-lg rounded mb-4">
                                                <div class="p-4 border-bottom">
                                                    <div class="row">
                                                        <div class="col-6">
                                            ...
                                            <h6 class="small text-muted fw-500">Extended Border Colors:</h6>
                                            <div class="border border-lg rounded mb-4">
                                                <div class="p-4 border-bottom">
                                                    <div class="row">
                                                        <div class="col-6">
                                ...
                                <div id="radius">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <h6 class="small text-muted fw-500">Rounded Corners:</h6>
                                            <div class="border border-lg rounded mb-4">
                                                <div class="p-4 border-bottom">
                                                    <div class="row">
                                                        <div class="col-4">
                                                        ...
                                                        <div class="col-4">
                                                            <div class="bg-primary text-white rounded-end p-3 mb-3">.rounded-end</div>
                                                            <div class="bg-primary text-white rounded-bottom p-3">.rounded-bottom</div>
                                                        </div>
                                                        <div class="col-4">
                                                            <div class="bg-primary text-white rounded-start p-3 mb-3">.rounded-start</div>
                                            ...
                                            <h6 class="small text-muted fw-500">Other Utilities:</h6>
                                            <div class="border border-lg rounded">
                                                <div class="p-4 border-bottom">
                                                    <div class="bg-primary text-white rounded-circle p-3 me-2 d-inline-flex align-items-center justify-content-center" style="height: 10rem; width: 10rem">.rounded-circle</div>
                                                    <div class="bg-primary text-white rounded-pill p-3 me-2 d-inline-flex align-items-center justify-content-center" style="height: 5rem; width: 10rem">.rounded-pill</div>
                                                </div>
                                                <div class="bg-light p-4 small">
                                                    It is recommended that you only use the
                                                    <code>.rounded-circle</code>
                                                    utility on square elements and the
                                                    <code>.rounded-pill</code>
                                                    utility on elements with a width that is larger than it's height.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="border border-lg rounded">
                                                <div class="p-4 border-bottom">
                                                    ...
                                                    <div class="bg-primary text-white rounded p-3 mb-3">.rounded</div>
                                                    <div class="bg-primary text-white rounded-lg p-3 mb-3">.rounded-lg</div>
                                                    <div class="bg-primary text-white rounded-xl p-3">.rounded-xl</div>
                                                </div>
                                                <div class="bg-light p-4 small">
                                                    You can set the border radius sizes in by changes their respective SCSS variables in the
                                                    <code>../variables/components.scss</code>
                                                    file.
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <div class="border border-lg rounded">
                                                <div class="p-4 border-bottom">
                                                    <div class="bg-light border p-3 mb-3">.border</div>
                                                    <div class="bg-light border border-lg p-3 mb-3">.border .border-lg</div>
                                                    <div class="bg-light border-top border-lg p-3 mb-3">.border-top .border-lg</div>
                                                    <div class="bg-light border-end border-lg p-3 mb-3">.border-end .border-lg</div>
                                                    <div class="bg-light border-bottom border-lg p-3 mb-3">.border-bottom .border-lg</div>
                                                    <div class="bg-light border-start border-lg p-3">.border-start .border-lg</div>
                                                </div>
                                                <div class="bg-light p-4 small">
                                                    You can change to a thicker border radius using the
                                                    <code>.border-lg</code>
                                                    utility classes, which extends the default Bootstrap functionalilty.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="usage">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <h6 class="small text-muted fw-500">Basic Combinations:</h6>
                                            <div class="border border-lg rounded mb-4">
                                                <div class="p-4 border-bottom">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="bg-light border-start border-lg rounded border-primary p-3 mb-3">Combine border position, radius, color, and thickness utilities!</div>
                                                            <div class="bg-light border-top border-lg rounded border-warning p-3">Combine border position, radius, color, and thickness utilities!</div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="bg-light border-end border-lg rounded border-secondary p-3 mb-3">Combine border position, radius, color, and thickness utilities!</div>
                                                            <div class="bg-light border-bottom border-lg rounded border-danger p-3">Combine border position, radius, color, and thickness utilities!</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <h6 class="small text-muted fw-500">Modified Cards:</h6>
                                            <div class="border border-lg rounded mb-4">
                                                <div class="p-4 border-bottom">
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="card border-start-lg border-primary mb-4"><div class="card-body">This is a custom card with a thick, colored border.</div></div>
                                                            <div class="card border-top-lg border-warning mb-4"><div class="card-body">This is a custom card with a thick, colored border.</div></div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="card border-end-lg border-secondary mb-4"><div class="card-body">This is a custom card with a thick, colored border.</div></div>
                                                            <div class="card border-bottom-lg border-danger mb-4"><div class="card-body">This is a custom card with a thick, colored border.</div></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <h6 class="small text-muted fw-500">Modified Alerts:</h6>
                                            <div class="border border-lg rounded">
                                                <div class="p-4 border-bottom">
                                                    <div class="alert alert-primary alert-icon border-start-lg" role="alert">
                                                        ...
                                                        <div class="alert-icon-content">
                                                            ...
                                                            This alert has a thick left border!
                                                        </div>
                                                    </div>
                                                    <div class="alert alert-secondary alert-icon border-top-lg mb-0" role="alert">
                                                        <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
                                                        <div class="alert-icon-aside"><i class="far fa-bell"></i></div>
                                                        <div class="alert-icon-content">
                                                            <h6 class="alert-heading">Secondary Icon Alert</h6>
                                                            This alert has a thick top border!
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav flex-column" id="stickyNav">
                                                ...
                                                <li class="nav-item"><a class="nav-link" href="#radius">Radius</a></li>
                                                <li class="nav-item"><a class="nav-link" href="#radiusSize">Radius Size</a></li>
                                                <li class="nav-item"><a class="nav-link" href="#thickness">Thickness</a></li>
