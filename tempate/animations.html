...
<html lang="en">
    <head>
        ...
        <title>Animations - SB Admin Pro</title>
                            ...
                            <div class="page-header-content pt-4">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">Custom animation utilities to add motion to your transitioning content</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownFadeIn">
        ...
        <a class="dropdown-item" href="#!">Something else here</a>
                                                        ...
                                                        <div class="tab-pane" id="animationFadeInExamplePug" role="tabpanel" aria-labelledby="animationFadeInExamplePugTab">
                                                            <pre class="language-pug"><code>//- Fade In Animation
.dropdown
    ...
    .dropdown-menu.animated--fade-in(aria-labelledby='dropdownFadeIn')
        ...
        a.dropdown-item(href='#!') Something else here</code></pre>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="sbp-preview">
                                                <div class="sbp-preview-content">
                                                    <div class="dropdown">
                                                        <button class="btn btn-secondary dropdown-toggle" id="dropdownFadeIn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Click Me!</button>
                                                ...
                                                <div class="sbp-preview-code">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="animationFadeInUpExampleHtml" role="tabpanel" aria-labelledby="animationFadeInUpExampleHtmlTab">
                                                            <pre class="language-markup"><code><script type="text/plain"><!-- Fade In Up Animation -->
<div class="dropdown">
    <button class="btn btn-secondary dropdown-toggle" id="dropdownFadeIn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Click Me!</button>
    <div class="dropdown-menu animated--fade-in-up" aria-labelledby="dropdownFadeIn">
        <a class="dropdown-item" href="#!">Action</a>
        ...
        <a class="dropdown-item" href="#!">Something else here</a>
                                                        ...
                                                        <div class="tab-pane" id="animationFadeInUpExamplePug" role="tabpanel" aria-labelledby="animationFadeInUpExamplePugTab">
                                                            <pre class="language-pug"><code>//- Fade In Up Animation
.dropdown
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav flex-column" id="stickyNav">
                                                <li class="nav-item"><a class="nav-link" href="#fadeIn">Fade In</a></li>
                                                <li class="nav-item"><a class="nav-link" href="#fadeInUp">Fade In Up</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
