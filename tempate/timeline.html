...
<html lang="en">
    <head>
        ...
        <title>Timeline - SB Admin Pro</title>
                            ...
                            <div class="page-header-content pt-4">
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        ...
                                        <div class="page-header-subtitle">A custom component for creating timelines</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="sbp-preview">
                                                ...
                                                <div class="sbp-preview-code">
                                                    <!-- Code sample-->
                                                    <ul class="nav nav-tabs" id="timelineExampleTabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active me-1" id="timelineExampleExampleHtmlTab" data-bs-toggle="tab" href="#timelineExampleExampleHtml" role="tab" aria-controls="timelineExampleExampleHtml" aria-selected="true">
                                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                                HTML
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="timelineExampleExamplePugTab" data-bs-toggle="tab" href="#timelineExampleExamplePug" role="tab" aria-controls="timelineExampleExamplePug" aria-selected="false">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="timelineExampleExampleHtml" role="tabpanel" aria-labelledby="timelineExampleExampleHtmlTab">
                                                            <pre class="language-markup"><code><script type="text/plain"><!-- Fade In Animation -->
<div class="timeline">
    <div class="timeline-item">
        <div class="timeline-item-marker">
        ...
        <div class="timeline-item-content">First item</div>
    </div>
    <div class="timeline-item">
        <div class="timeline-item-marker">
            <div class="timeline-item-marker-text">...</div>
        ...
        <div class="timeline-item-content">Second item</div>
    </div>
    <div class="timeline-item">
        <div class="timeline-item-marker">
            <div class="timeline-item-marker-text">...</div>
        ...
        <div class="timeline-item-content">Third item</div>
    </div>
</div></script></code></pre>
                                                        </div>
                                                        <div class="tab-pane" id="timelineExampleExamplePug" role="tabpanel" aria-labelledby="timelineExampleExamplePugTab">
                                                            <pre class="language-pug"><code>//- Timeline component
.timeline
    .timeline-item
        ...
        .timeline-item-content
            | Third item</code></pre>
                                                ...
                                                <div class="sbp-preview-text">
                                                    The
                                                    <code>.timeline</code>
                                                    component allows you to add a
                                                    <code>.timeline-item</code>
                                                    to display content within a sequence. The timeline also includes a marker, a field to the left of the marker for a date, and a line connecting the markers. This is a custom component designed specifically for use in the SB Admin Pro theme.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <!-- Small timeline component-->
                                <div id="timelineSmall">
                                    <div class="card mb-4">
                                        <div class="card-header">Small Timeline Variant</div>
                                        <div class="card-body">
                                            <!-- Component Preview-->
                                            <div class="sbp-preview">
                                                <div class="sbp-preview-content">
                                                ...
                                                <div class="sbp-preview-code">
                                                    <!-- Code sample-->
                                                    <ul class="nav nav-tabs" id="timelineSmTabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active me-1" id="timelineSmExampleHtmlTab" data-bs-toggle="tab" href="#timelineSmExampleHtml" role="tab" aria-controls="timelineSmExampleHtml" aria-selected="true">
                                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                                HTML
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="timelineSmExamplePugTab" data-bs-toggle="tab" href="#timelineSmExamplePug" role="tab" aria-controls="timelineSmExamplePug" aria-selected="false">
                                                                <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                                PUG
                                                            </a>
                                                        </li>
                                                    ...
                                                    <!-- Tab panes-->
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="timelineSmExampleHtml" role="tabpanel" aria-labelledby="timelineSmExampleHtmlTab">
                                                            <pre class="language-markup"><code><script type="text/plain"><!-- Fade In Animation -->
<div class="timeline timeline-sm">
    <div class="timeline-item">
        <div class="timeline-item-marker">
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-item-content">Third item</div>
                                                        ...
                                                        <div class="tab-pane" id="timelineSmExamplePug" role="tabpanel" aria-labelledby="timelineSmExamplePugTab">
                                                            <pre class="language-pug"><code>//- Timeline component
        ...
        .timeline-item-content
            | Third item</code></pre>
                                                ...
                                                <div class="sbp-preview-text">
                                                    ...
                                                    <code>.timeline</code>
                                                    component with the
                                                    <code>.timeline-sm</code>
                                                    class to use a smaller, more condensed version of the timeline. Keep in mind also that using icons is optional!
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <!-- Extra Small timeline component-->
                                <div id="timelineXs">
                                    <div class="card mb-4">
                                        <div class="card-header">Extra Small Timeline Variant</div>
                                        <div class="card-body">
                                            <!-- Component Preview-->
                                            <div class="sbp-preview">
                                                <div class="sbp-preview-content">
                                                ...
                                                <div class="sbp-preview-code">
                                                    <!-- Code sample-->
                                                    <ul class="nav nav-tabs" id="timelineXsTabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active me-1" id="timelineXsExampleHtmlTab" data-bs-toggle="tab" href="#timelineXsExampleHtml" role="tab" aria-controls="timelineXsExampleHtml" aria-selected="true">
                                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                                HTML
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="timelineXsExamplePugTab" data-bs-toggle="tab" href="#timelineXsExamplePug" role="tab" aria-controls="timelineXsExamplePug" aria-selected="false">
                                                                <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                                PUG
                                                            </a>
                                                        </li>
                                                    ...
                                                    <!-- Tab panes-->
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="timelineXsExampleHtml" role="tabpanel" aria-labelledby="timelineXsExampleHtmlTab">
                                                            <pre class="language-markup"><code><script type="text/plain"><!-- Fade In Animation -->
<div class="timeline timeline-xs">
    <div class="timeline-item">
        <div class="timeline-item-marker">
    ...
    <div class="timeline-item">
        ...
        <div class="timeline-item-content">Third item</div>
                                                        ...
                                                        <div class="tab-pane" id="timelineXsExamplePug" role="tabpanel" aria-labelledby="timelineXsExamplePugTab">
                                                            <pre class="language-pug"><code>//- Timeline component
        ...
        .timeline-item-content
            | Third item</code></pre>
                                ...
                                <div id="timelineStyled">
                                    <div class="card mb-4">
                                        <div class="card-header">Styled Timeline Component Example</div>
                                        <div class="card-body">
                                            <!-- Component Preview-->
                                            <div class="sbp-preview">
                                                <div class="sbp-preview-content">
                                                    <div class="timeline">
                                                        <div class="timeline-item">
                                                            ...
                                                            <div class="timeline-item-content pt-0">
                                                                <div class="card shadow-sm">
                                                                    <div class="card-body">
                                                                        <h5 class="text-primary">Beginning</h5>
                                                        ...
                                                        <div class="timeline-item">
                                                            ...
                                                            <div class="timeline-item-content pt-0">
                                                                <div class="card shadow-sm">
                                                                    <div class="card-body">
                                                                        <h5 class="text-success">Second Item</h5>
                                                        ...
                                                        <div class="timeline-item">
                                                            ...
                                                            <div class="timeline-item-content pt-0">
                                                                <div class="card shadow-sm">
                                                                    <div class="card-body">
                                                                        <h5 class="text-secondary">Third Item</h5>
                                                        ...
                                                        <div class="timeline-item">
                                                            ...
                                                            <div class="timeline-item-content pt-0">
                                                                <div class="card shadow-sm">
                                                                    <div class="card-body">
                                                                        <h5 class="text-warning">Last Item</h5>
                                                ...
                                                <div class="sbp-preview-code">
                                                    <!-- Code sample-->
                                                    <ul class="nav nav-tabs" id="timelineStyledExampleTabs" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active me-1" id="timelineStyledExampleHtmlTab" data-bs-toggle="tab" href="#timelineStyledExampleHtml" role="tab" aria-controls="timelineStyledExampleHtml" aria-selected="true">
                                                                <i class="fab fa-html5 text-orange me-1"></i>
                                                                HTML
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="timelineStyledExamplePugTab" data-bs-toggle="tab" href="#timelineStyledExamplePug" role="tab" aria-controls="timelineStyledExamplePug" aria-selected="false">
                                                                <img class="img-pug me-1" src="assets/img/demo/pug.svg" />
                                                                PUG
                                                            </a>
                                                        </li>
                                                    ...
                                                    <!-- Tab panes-->
                                                    <div class="tab-content">
                                                        <div class="tab-pane active" id="timelineStyledExampleHtml" role="tabpanel" aria-labelledby="timelineStyledExampleHtmlTab">
                                                            <pre class="language-markup"><code><script type="text/plain"><!-- Styled timeline component example -->
<div class="timeline">
    <div class="timeline-item">
        <div class="timeline-item-marker">
            <div class="timeline-item-marker-text">01/01/2021</div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    You can use different icons in the icon markers, letters, or no icons at all if you just want a blank circle.
                                                        ...
                                                        <div class="tab-pane" id="timelineStyledExamplePug" role="tabpanel" aria-labelledby="timelineStyledExamplePugTab">
                                                            <pre class="language-pug"><code>//- Styled timeline component example
.timeline
    .timeline-item
        .timeline-item-marker
            .timeline-item-marker-text
            ...
            .card.shadow-sm
                .card-body
                    ...
                    | You can use different icons in the icon markers, letters, or no icons at all if you just want a blank circle.
                                                ...
                                                <div class="sbp-preview-text">Use built in utility classes to change the presentation of the timeline content and the styling of the timeline markers.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav flex-column" id="stickyNav">
                                                <li class="nav-item"><a class="nav-link" href="#timelineBasic">Basic Timeline</a></li>
                                                <li class="nav-item"><a class="nav-link" href="#timelineSmall">Small Timeline</a></li>
                                                <li class="nav-item"><a class="nav-link" href="#timelineXs">Extra Small Timeline</a></li>
                                                <li class="nav-item"><a class="nav-link" href="#timelineStyled">Styled Timeline</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
